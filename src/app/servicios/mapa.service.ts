...
export class MapaService {
  ...
  mapa: any;
  style: string = 'mapbox://styles/mapbox/streets-v11'; // Estilo del mapa (en este caso, streets-v11)';
  directions: any;
  marcadores: any[];

  constructor() {
    mapboxgl.accessToken = 'pk.eyJ1Ijoic3NhYm9nYWxnIiwiYSI6ImNsdmR3eG1vazAzamgycnA2Mzc0cmIya28ifQ.22cFggl9ENzJD6kq4606tQ'; // Token de acceso
    this.marcadores = [];
  }
